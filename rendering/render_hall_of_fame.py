...
def render_hall_of_fame_normal(tetris_font, font):
    sorted_data = load_and_sort_data("player_score.json")
    screen.blit(image_bcg_hall_of_fame, (0,0))
    Py.draw.rect(screen, Py.Color(255, 255, 255), rect_hall_of_fame)
    text_titre = tetris_font.render('Hall Of Fame', True, ('blue'))
    titre_text = text_titre.get_rect(center=rect_hall_of_fame.center)
    ...
    text_premier = font.render(str(sorted_data[0]), True, ('blue'))
    ...
    text_deuxieme = font.render(str(sorted_data[1]), True, ('blue'))
    ...
    text_troisieme = font.render(str(sorted_data[2]), True, ('blue'))
...
def render_hall_of_fame_survival(tetris_font, font):
    sorted_data = load_and_sort_data("player_time.json")
    screen.blit(image_bcg_hall_of_fame, (0,0))
    Py.draw.rect(screen, Py.Color(255, 255, 255), rect_hall_of_fame)
