...
def render_end_game(tetris_font, font, score):
    ...
    Py.draw.rect(screen, Py.Color(255, 255, 255), rect_return)
    ...
    text_return = font.render('Retour', True, ('black'))
    return_text = text_return.get_rect(center=rect_return.center)
    screen.blit(text_return, return_text)